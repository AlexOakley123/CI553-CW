...
public class CustomerModel extends Observable
{
  ...
  public void theBtReserve(String pn) {
    try {
      if (theStock.exists(pn))
      {
        ...
        {
          String theAction = "";
          theAction = "Item reserved";
          setChanged();
          notifyObservers(theAction);
          CashierModel.Reserved =  pn;
          CashierView.ReservedUpdate();
          theStock.buyStock(pn, 1);

        } else {
          String theAction = "";
          theAction = "Item not available to be reserved";
          setChanged();
          notifyObservers(theAction);
        }
      } else {
  ...
  public void textChange(String inputField) {
    try {
