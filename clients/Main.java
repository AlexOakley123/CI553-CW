...
import clients.advert.AdvertModel;
import clients.advert.AdvertView;
import clients.advert.AdvertController;
...
class Main
{
  ...
  public void startAdvertGUI_MVC(MiddleFactory mlf )
  {
    ...
    AdvertModel model      = new AdvertModel(mlf);
    AdvertView view        = new AdvertView( window, mlf, pos.width, pos.height );
